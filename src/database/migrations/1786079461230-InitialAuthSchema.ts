...
export class InitialAuthSchema1786079461230 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "auth"."roles_name_enum" AS ENUM('SUPER_ADMIN', 'ADMIN', 'USER')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_3ddc983c5f7bcf132fd8732c3f" ON "auth"."refresh_tokens"  ("user_id") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "auth"."otp_verifications_purpose_enum" AS ENUM('REGISTER', 'LOGIN', 'FORGOT_PASSWORD')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_c7f1d281e1acc51e2a37889f5a" ON "auth"."otp_verifications"  ("user_id") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_e13f2874d645c0cd9964d06008" ON "auth"."otp_verifications"  ("email") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "auth"."refresh_tokens" ADD CONSTRAINT "FK_3ddc983c5f7bcf132fd8732c3f4" FOREIGN KEY ("user_id") REFERENCES "auth"."users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "auth"."otp_verifications" ADD CONSTRAINT "FK_c7f1d281e1acc51e2a37889f5a9" FOREIGN KEY ("user_id") REFERENCES "auth"."users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE IF EXISTS "auth"."otp_verifications" DROP CONSTRAINT IF EXISTS "FK_c7f1d281e1acc51e2a37889f5a9"`,
    );
    await queryRunner.query(
      `ALTER TABLE IF EXISTS "auth"."refresh_tokens" DROP CONSTRAINT IF EXISTS "FK_3ddc983c5f7bcf132fd8732c3f4"`,
    );
    await queryRunner.query(
      `ALTER TABLE IF EXISTS "auth"."user_roles" DROP CONSTRAINT IF EXISTS "FK_b23c65e50a758245a33ee35fda1"`,
    );
    await queryRunner.query(
      `ALTER TABLE IF EXISTS "auth"."user_roles" DROP CONSTRAINT IF EXISTS "FK_87b8888186ca9769c960e926870"`,
    );
    await queryRunner.query(
      `DROP INDEX IF EXISTS "auth"."IDX_e13f2874d645c0cd9964d06008"`,
    );
    await queryRunner.query(
      `DROP INDEX IF EXISTS "auth"."IDX_c7f1d281e1acc51e2a37889f5a"`,
    );
    await queryRunner.query(`DROP TABLE IF EXISTS "auth"."otp_verifications"`);
    await queryRunner.query(
      `DROP TYPE IF EXISTS "auth"."otp_verifications_purpose_enum"`,
    );
    ...
    await queryRunner.query(
      `DROP INDEX IF EXISTS "auth"."IDX_3ddc983c5f7bcf132fd8732c3f"`,
    );
